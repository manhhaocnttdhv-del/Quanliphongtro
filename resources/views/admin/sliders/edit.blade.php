...
<div class="mb-4">
    ...
    <h1 class="fs-3 mb-1">Sửa Slide #{{ $slider->id }}</h1>
</div>
        ...
        <div class="card p-4">
            <form method="POST" action="{{ route('admin.sliders.update', $slider) }}" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <div>
                        <img src="{{ asset('storage/'.$slider->image_path) }}" alt="Current"
                             style="max-height:160px;border-radius:10px;border:1px solid #e2e8f0;">
                    </div>
                </div>

                <div class="mb-3">
                    <label class="form-label fw-semibold">Thay ảnh mới (để trống nếu không đổi)</label>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('title') is-invalid @enderror"
                           ...
                           placeholder="VD: Phòng trọ giá rẻ, tiện nghi">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('subtitle') is-invalid @enderror"
                           name="subtitle" value="{{ old('subtitle', $slider->subtitle) }}"
                           placeholder="Dòng mô tả ngắn dưới tiêu đề">
                ...
                <div class="mb-3">
                    ...
                    <input type="url" class="form-control @error('link') is-invalid @enderror"
                           name="link" value="{{ old('link', $slider->link) }}" placeholder="https://...">
                    ...
                    <div class="col-md-6 d-flex align-items-end">
                        <div class="form-check form-switch mb-2">
                            <input class="form-check-input" type="checkbox" name="is_active" value="1"
                                   id="isActiveCheck" {{ $slider->is_active ? 'checked' : '' }}>
                            <label class="form-check-label fw-semibold" for="isActiveCheck">Hiển thị</label>
                        </div>
                    </div>
                </div>
